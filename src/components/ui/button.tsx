...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap border-[1px] border-solid border-primary_2 transition-all font-[500] rounded-[5px] disabled:cursor-not-allowed disabled:opacity-65",
  {
    variants: {
      variant: {
        default:
